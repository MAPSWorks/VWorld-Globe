...
bool cViewer::OnInit()
{
	...
	m_infoView->Create(eDockState::DOCKWINDOW, eDockSlot::RIGHT, this, m_mapView, 0.3f, framework::eDockSizingOption::PIXEL);

	m_observerView = new cObserverView("Observer View");
	m_observerView->Create(eDockState::DOCKWINDOW, eDockSlot::BOTTOM, this, m_mapView, 0.3f);// 0.6f, framework::eDockSizingOption::PIXEL);
